...
CREATE UNIQUE INDEX idx_dept_perm_uk ON sys_department_permission(department_id, permission_id);
CREATE INDEX idx_dept_perm_department_id ON sys_department_permission(department_id);
CREATE INDEX idx_dept_perm_permission_id ON sys_department_permission(permission_id);
